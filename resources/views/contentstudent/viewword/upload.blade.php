...
@section('content')
	<div class="container">
        <form action="{{ url('student/word/upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-6 mb-2">
                            ...
                            <input type="text" class="form-control" name="filename" maxlength="191" value="{{ $getword->filename }}" pattern="[a-zA-Z0-9\s]*" placeholder="Enter your Filename" readonly/>
                        </div>
                        <div class="col-lg-6 mb-2">
                            <label>Status</label>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-success" type="button">
                                        <input type="file" name="word" class="custom-file-input" id="customFile" accept=".docx" hidden required>
