...
<div class="wrapper-page">
    <div class="card-block">
        ...
        <h4 class="text-muted text-center"><b>Officer SIGN IN</b></h4>
        <div class="p-3">
            <form class="form-horizontal m-t-20" method="POST" action="{{ url('officer/login') }}">
                @csrf
                ...
                <div class="form-group m-t-10 mb-0 row">
                    <div class="col-sm-12 m-t-20 text-right">
                        {{-- <a href="{{ route('officer.password.request') }}" class="text-muted"><i class="mdi mdi-lock"></i> ลืมรหัสผ่าน?</a> --}}
                    </div>
                </div>
            </form>
        </div>
